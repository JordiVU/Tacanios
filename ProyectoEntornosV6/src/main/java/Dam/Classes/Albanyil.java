...
public class Albanyil extends Trabajador
{
    ...
    /**
     * Metodo el cual nos permitira seleccionar una lista de albañiles los
     * cuales luego se asociaran a un trabajo el cual necesite varios
     * albañiles para ello se pasara como parametro la lista de trabajadores
     * y se devolvera una lista de albañiles.
     * @param trabajadores
     * @return
     */
    public static List<Albanyil> SeleccionarAlbanyiles(List<Trabajador> trabajadores) {
        ...
        for(int i = 0; i < trabajadores.size(); i++) {
            if(trabajadores.get(i) instanceof Albanyil) {
        ...
        for(int i = 0; i < cantAlbanyiles; i++){
            ...
            albanyiles.add((Albanyil)trabajadores.get(seleccion - 1));
    ...
    public String toString() {
        return super.user + " | Rango: " + rango + " " + especializacion + " " + anyosExp + " años de experiencia.";
    }
}
