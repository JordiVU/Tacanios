...
public class Pintor extends Trabajador
{
    ...
    /**
     * Metodo el cual servira para cuando algún adminsitrador seleccione
     * algún pintor validar que este es correcto. Para ello se pasaran
     * como parametro la lista de trabajadores.
     * @param trabajadores
     * @return
     */
