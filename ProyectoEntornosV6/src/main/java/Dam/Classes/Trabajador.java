...
public abstract class Trabajador
{
    ...
    /**
     * Metodo el cual sirve para leer mediante gestion de ficheros la lista
     * de trabajadores, en este metodo se devolvera la lista de trabajadores
     * la cual se usara en el main para el resto del programa.
     * @return
     */
