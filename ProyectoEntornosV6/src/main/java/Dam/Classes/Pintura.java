...
public class Pintura extends Trabajo
{
    ...
    public Pintura(int codTrabajo, int metros2,
                   Presupuesto presupuestoAsignado, Direccion direccionAsociada, Cliente clienteAsociado,
    ...
    public String toString() {
        return super.toString() + " | " + tipoPintura + " tipo de pintura | " + color + "color | " + estanciasAPintar +
                " estancias a pintar | Pintor:" + pintor;
    }
}
